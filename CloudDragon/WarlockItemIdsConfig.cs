...
{
    public class WarlockItemIdsConfig
    {
        public string Base { get; set; }
        public string Archfey { get; set; }
        public string Celestial { get; set; }
        public string Fathomless { get; set; }
        public string Fiend { get; set; }
        public string Genie { get; set; }
        public string GreatOldOne { get; set; }
        public string Hexblade { get; set; }
