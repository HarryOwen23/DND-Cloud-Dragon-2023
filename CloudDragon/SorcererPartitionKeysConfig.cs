...
{
    public class SorcererPartitionKeysConfig
    {
        public string Base { get; set; }
        public string AberrantMind { get; set; }
        public string ClockworkSoul { get; set; }
        public string DraconicBloodline { get; set; }
        public string DivineSoul { get; set; }
        public string LunarSorcery { get; set; }
        public string ShadowMagic { get; set; }
        public string StormSorcery { get; set; }
